...
head_ID.appendChild(script_element);
  ...
  googletag.cmd.push(function() {
    googletag.defineSlot('/21920883086/StickyM2', [300, 100], 'div-gpt-ad-1623269214952-0').addService(googletag.companionAds()).addService(googletag.pubads());
...
// Membuat Konten
var HTMLX = '<div class="RyanSticky" id="stickyAd"><div id="div-gpt-ad-1623269214952-0" style="min-width: 300px; min-height: 100px;"></div><button aria-label="Close this ad" class="RyanStickyClose" onClick="document.getElementById(\'stickyAd\').style=\'display:none\'"></button></div>';
var elem = document.createElement('div');
elem.innerHTML = HTMLX;
document.body.appendChild(elem);

// Menjalankan Skrip Ads
   googletag.cmd.push(function() { googletag.display('div-gpt-ad-1623269214952-0'); });
