...
head_ID.appendChild(script_element);
  ...
  googletag.cmd.push(function() {
    googletag.defineSlot('/21920883086/StickyFixedBawah', ['fluid'], 'div-gpt-ad-1620776985901-0').addService(googletag.companionAds()).addService(googletag.pubads());
...
// Membuat Konten
var HTMLX = '<div class="RyanSticky" id="stickyAd"><div id="div-gpt-ad-1620776985901-0"></div><button aria-label="Close this ad" class="RyanStickyClose" onClick="document.getElementById(\'stickyAd\').style=\'display:none\'"></button></div>';
var elem = document.createElement('div');
elem.innerHTML = HTMLX;
document.body.appendChild(elem);

// Menjalankan Skrip Ads
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1620776985901-0'); });
