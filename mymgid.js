...
var ads = ['<div style="max-height:300px !important;"><div id="AdsRyanAH"><div id="M493082ScriptRootC872823"></div><button aria-label="Close this ad" class="btnRyanAH" onclick="hideIt()" id="btnHide"></button></div></div>', '<div id="M493082ScriptRootC742072"></div>'];
// Run Scripts
insertAd('adsRefresh1', 0);
insertAd('adsRefresh2', 1);
function insertAd(div,v){
document.getElementById(div).innerHTML=ads[v];
}
